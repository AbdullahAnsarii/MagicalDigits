import { Button, Container, Stack, Tooltip, Divider, Box, Grid, List, ListItem, ListItemText, ListItemIcon, Paper } from '@mui/material';
...
const OurStory = () => {
    ...
    return (
        <Container id="changeit" maxWidth='lg'>
            <Head>
